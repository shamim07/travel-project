...
const About = () => {
  ...
  const settings = {
    ...
    autoplaySpeed: 3000,
    arrows: true,
    rtl: true, // Enables right-to-left direction
  };

  return (
    <div >
      <section className="bg-gradient-to-r from-teal-500 to-cyan-600 text-white pt-[200px] pb-[100px]">
        <div className="container mx-auto px-6 sm:px-12 lg:px-24 flex flex-col lg:flex-row justify-between gap-8">
          {/* Left Side - Text Section */}
          <div className="lg:w-1/2 mb-9 lg:mb-0">
